    ...
    <div className="flex items-center justify-center py-10">
      <div className="relative w-full max-w-full md:max-w-[1360px] h-[50vh] sm:h-[60vh] md:h-[70vh] overflow-hidden">
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center text-center px-4 space-y-4">
          <h1 className="text-2xl md:text-5xl font-bold text-white p-4 rounded-md w-[80%] sm:w-[90%] md:w-[70%]">
            Connecting BIT Sindri Alumni and Students
          </h1>
          <p className="text-sm md:text-base w-[80%] sm:w-[90%] md:w-[70%] text-white p-4 rounded-md mt-2">
            Welcome to the BIT Sindri Alumni Network, where we bridge the gap
            between alumni and current students. Join us to explore mentorship
