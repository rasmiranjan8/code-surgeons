...
return(
<div className="w-full bg-darkblue text-white px-4 sm:px-8 lg:px-16">
{/* Upper Section */}
<div className="flex flex-wrap w-full py-8">
  ...
  <div className="w-full lg:w-1/2 p-6 text-center lg:text-left">
    <div>
      Subscribe to our monthly newsletter for the latest updates, events, and opportunities tailored for BIT Sindri alumni and students. Don't miss out on valuable insights and networking chances!
    </div>
    <form
      onSubmit={handleSubscribe}
      className="flex flex-col lg:flex-row space-y-4 lg:space-y-0 lg:space-x-4 py-4 items-center lg:items-start"
    >
      <input
        type="email"
      ...
      <button
        type="submit"
        className="bg-customBlue text-white hover:text-black hover:bg-white px-6 py-2 rounded w-full lg:w-auto"
      >
        Subscribe
      </button>
    </form>
...
<div className="flex flex-wrap items-center justify-between p-6 py-16 bg-darkblue space-y-8 lg:space-y-0">
  {/* Logo */}
  <div className="w-full lg:w-auto flex justify-center lg:justify-start">
    <img src="/BIT_Sindri_Logo.png" alt="logo" className="h-20 lg:h-28" />
  </div>

  {/* Navigation Links */}
  <ul className="w-full lg:w-auto flex flex-wrap justify-center lg:justify-start space-x-6 lg:space-x-16 text-center">
    <li>
